...
\033[0;33m              | .--------------. |
\033[0;33m              | |   made by    | |
\033[0;33m              | |  nonmenowife | |
\033[0;33m              | |follow:tiktok | |
\033[0;33m              | | nonamenowife | |
\033[0;33m              | |  V:1.8       | |
\033[0;33m              | |   _______    | |
\033[0;33m              | |  |_______|   | |
\033[0;33m              | '--------------' |
...
print("Hello To nonameNowife Gift Card Generator")
print("----------------------------------------------------------------")
...
#Number To Generate
number = int(total)
file = (total + " Generated By NonameNowife.txt")
file2 = 'ThisyourCards.txt'
print("-------------------------------------------------------------------------------")
...
if(mode == "IMVU"):
    ...
    for x in range(number):
        ...
        with open(file, 'a') as out:
            out.write(generate1+generate2+generate3+generate4+generate5+generate6+generate7+generate8+generate9+generate10+newline)
print("------------------------------------------------------------------------------------------------")            
print ("\033[0;34m Thanks For Using My Script NonameNowife Was Here")
time.sleep(5)
